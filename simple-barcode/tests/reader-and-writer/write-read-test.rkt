...
(require rackunit "../../lib/writer.rkt")
  ...
  (test-suite
   ...
   (test-case
    ...
    (dynamic-wind
        ...
        (lambda ()
          (delete-file barcode-read ean13_file)
          (delete-file barcode-read ean13_w5_file)
          (delete-file barcode-read ean13_color_file)
          (delete-file barcode-read ean13_trans_file))))
   ...
   (test-case
    ...
    (dynamic-wind
        (lambda ()
          (barcode-write "chenxiao770117" code128_file)
          (barcode-write "chenxiao770117" code128_w5_file #:brick_width 5)
          (barcode-write "chenxiao770117" code128_color_file #:color_pair '("red" . "gray"))
          (barcode-write "chenxiao770117" code128_trans_file #:color_pair '("red" . "transparent")))
        (lambda ()
        ...
        (lambda ()
          (delete-file barcode-read code128_file)
          (delete-file barcode-read code128_w5_file)
          (delete-file barcode-read code128_color_file)
          (delete-file barcode-read code128_trans_file))))
