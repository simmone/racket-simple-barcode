   ...
   (test-case
    ...
    (dynamic-wind
        ...
        (lambda ()
          ...
          (check-equal? (barcode-read code39_file) "chenxiao770117")
          (printf "t1\n")
          (check-equal? (barcode-read code39_w5_file) "chenxiao770117")
          (printf "t2\n")
          (check-equal? (barcode-read code39_color_file) "chenxiao770117")
          (printf "t3\n")
          (check-equal? (barcode-read code39_trans_file) "chenxiao770117")
          (printf "t4\n")
          )
        (lambda ()
